...
loop: 
    ...
    movq  %rsi, %rcx // Load n into rcx %rcx = n
  ...
  .L3:
    ...
    salq  %cl, %rdx // %rdx << %cl shift by n bits
...
// It gets updated by shifting to the left by n bits

/* E. How does result get updated? */
// Result is XOR'd with x [bitwise-and mask]
